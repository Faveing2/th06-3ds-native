...
- [ ] Allow the data files to be loaded from the SDCard rather than included in the romfs, allows the binary to be distributed without distributing the game assets
